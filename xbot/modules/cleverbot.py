...
class CleverBot(object):
	...
	def __init__(self):
		...
		self.bot1session = bot1.create_session()
		self.parser = HTMLParser.HTMLParser()
	
	def query(self, thought):
		return self.parser.unescape(self.bot1session.think(thought)).encode('utf-8')
		#self.params['stimulus'] = thought
		#data = urllib.urlencode(self.params)
		#data += '&icognocheck=' + hashlib.md5(data[9:29]).hexdigest()
		#responses = urllib2.urlopen("http://www.cleverbot.com/webservicemin", data, timeout = 30).read().split('\r')
